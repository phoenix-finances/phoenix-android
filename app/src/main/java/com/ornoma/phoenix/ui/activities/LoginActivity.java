...
import com.ornoma.phoenix.lib.KeyValuePair;

public class LoginActivity extends AppCompatActivity implements
        GoogleApiClient.OnConnectionFailedListener,
        View.OnClickListener {

    public static final String KEY_IS_SIGNED_IN = "_key_is_signed_in_0923";
...
/* OnConnectionFailedListener *//*
    ...
    public void onStart() {
        ...
        String value = KeyValuePair.getInstance(this).getValue(KEY_IS_SIGNED_IN);
    ...
    private void startLauncher(){
        KeyValuePair.getInstance(this).update(KEY_IS_SIGNED_IN, "true");
        LinearLayout linearLayoutHolder = (LinearLayout)findViewById(R.id.linearLayout_splash);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                finish();
                Intent intentLauncher = new Intent(LoginActivity.this, LauncherActivity.class);
